				...
				<tr>
					...
					<td align="left">
						...
						<?
							...
							//DB에 입력된 값 불러오기		
							$ck_goal_sql = "
									SELECT * FROM nurse2016_ck_goal where n_key = '$n_key' and p_key = '$p_key' and pbList_num = '$pbNum' order by rec_key;
								   ";		
						...
						<font size = "3">
							&nbsp;&nbsp;<input type="text" style="width:420px;height:30px;vertical-align: middle;"  name="sur_txt_<?=$pbNum?>" <? if($ck_goal_db['pbList_goal']) echo "value='$goal_txt'"?>>
					...
					?>
						...
						<td align="left">
							&nbsp;&nbsp;<label><input type="radio" style="width:23px;height:23px;vertical-align: middle;"  name="sur_<?=$pbNum?>" value= "1" <? if($goal_same == "1") echo "checked"?>><b>&nbsp;<font size = "3">현재 기능 유지</font></b></label>
							&nbsp;&nbsp;<label><input type="radio" style="width:23px;height:23px;vertical-align: middle;"  name="sur_<?=$pbNum?>" value= "2" <? if($goal_same == "2") echo "checked"?>><b>&nbsp;<font size = "3">ADL 수행능력평가에서 한단계 향상</font></b></label>		
						</td>
					...
					?>
						<td align="left">
							&nbsp;&nbsp;<label><input type="radio" style="width:23px;height:23px;vertical-align: middle;"  name="sur_<?=$pbNum?>" value= "1" <? if($goal_same == "1") echo "checked"?>><b>&nbsp;<font size = "3">현재 기능 유지</font></b></label>
							&nbsp;&nbsp;<label><input type="radio" style="width:23px;height:23px;vertical-align: middle;"  name="sur_<?=$pbNum?>" value= "2" <? if($goal_same == "2") echo "checked"?>><b>&nbsp;<font size = "3">MMSE 점수(지남력, 기억력 등)  향상</font></b></label>		
						</td>
					...
					?>
						...
						<td align="left">
							&nbsp;&nbsp;<label><input type="radio" style="width:23px;height:23px;vertical-align: middle;"  name="sur_<?=$pbNum?>" value= "1" <? if($goal_same == "1") echo "checked"?>><b>&nbsp;<font size = "3">현재 기능 유지</font></b></label>
							&nbsp;&nbsp;<label><input type="radio" style="width:23px;height:23px;vertical-align: middle;"  name="sur_<?=$pbNum?>" value= "2" <? if($goal_same == "2") echo "checked"?>><b>&nbsp;<font size = "3">의사소통 기능(청취능력, 발음능력 등) 향상</font></b></label>		
						</td>
					...
					?>
						<td align="left">
							&nbsp;&nbsp;<label><input type="radio" style="width:23px;height:23px;vertical-align: middle;"  name="sur_<?=$pbNum?>" value= "1" <? if($goal_same == "1") echo "checked"?>><b>&nbsp;<font size = "3">현재 기능 유지</font></b></label>
							&nbsp;&nbsp;<label><input type="radio" style="width:23px;height:23px;vertical-align: middle;"  name="sur_<?=$pbNum?>" value= "2" <? if($goal_same == "2") echo "checked"?>><b>&nbsp;<font size = "3"> 사회적 지지기능(가족, 환경) 향상</font></b></label>		
						</td>
					...
					?>
						...
						<td align="left">
							&nbsp;&nbsp;<label><input type="radio" style="width:23px;height:23px;vertical-align: middle;"  name="sur_<?=$pbNum?>" value= "1" <? if($goal_same == "1") echo "checked"?>><b>&nbsp;<font size = "3">현재 기능 유지</font></b></label>
							&nbsp;&nbsp;<label><input type="radio" style="width:23px;height:23px;vertical-align: middle;"  name="sur_<?=$pbNum?>" value= "2" <? if($goal_same == "2") echo "checked"?>><b>&nbsp;<font size = "3">정서기능(불안, 우울, 초초 감소 등) 향상</font></b></label>		
						</td>
					...
					?>
						...
						<td align="left">
							&nbsp;&nbsp;<label><input type="radio" style="width:23px;height:23px;vertical-align: middle;"  name="sur_<?=$pbNum?>" value= "1" <? if($goal_same == "1") echo "checked"?>><b>&nbsp;<font size = "3">현재 기능 유지</font></b></label>
							&nbsp;&nbsp;<label><input type="radio" style="width:23px;height:23px;vertical-align: middle;"  name="sur_<?=$pbNum?>" value= "2" <? if($goal_same == "2") echo "checked"?>><b>&nbsp;<font size = "3">영적기능(종교활동 참여 증가 등) 향상</font></b></label>		
						</td>
					...
					?>
						...
						<td align="left">
							&nbsp;&nbsp;<label><input type="radio" style="width:23px;height:23px;vertical-align: middle;"  name="sur_<?=$pbNum?>" value= "1" <? if($goal_same == "1") echo "checked"?>><b>&nbsp;<font size = "3">통증 완화/감소</font></b></label>
							&nbsp;&nbsp;<label><input type="radio" style="width:23px;height:23px;vertical-align: middle;"  name="sur_<?=$pbNum?>" value= "2" <? if($goal_same == "2") echo "checked"?>><b>&nbsp;<font size = "3">통증이 사라짐</font></b></label>		
						</td>
