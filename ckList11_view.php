	...
	<tr>
		...
		<table width="100%" height="20" align="center" border="1" cellspacing="0" class="bbs_wm">
			<tr>
				...
				<td width = "85%"  align="left">&nbsp;&nbsp;
					<input type="checkbox" style="width:23px;height:23px;vertical-align: middle;"  name="sur_0[]" value= "1"><label>&nbsp;&nbsp;<b>의료기관</b>&nbsp;&nbsp;&nbsp;</label>
					<input type="checkbox" style="width:23px;height:23px;vertical-align: middle;"  name="sur_0[]" value= "2"><label>&nbsp;&nbsp;<b>종교활동</b>&nbsp;&nbsp;&nbsp;</label>
					<input type="checkbox" style="width:23px;height:23px;vertical-align: middle;"  name="sur_0[]" value= "3"><label>&nbsp;&nbsp;<b>자원봉사(이미용 등)</b>&nbsp;&nbsp;&nbsp;</label>		
				</td>
			</tr>
		</table>
		...
		<table width="100%" height="20" align="center" border="1" cellspacing="0" class="bbs_wm">
			...
			<tr>
				...
				<td width = "10%"  align="center"><input type="radio" style="width:23px;height:23px"  name="sur_1" value= "2"></td>
				<td width = "10%"  align="center"><input type="radio" style="width:23px;height:23px"  name="sur_1" value= "3"></td>
				<td width = "10%"  align="center"><input type="radio" style="width:23px;height:23px"  name="sur_1" value= "4"></td>
			</tr>
			...
			<tr>
				...
				<td width = "10%"  align="center"><input type="radio" style="width:23px;height:23px"  name="sur_2" value= "2"></td>
				<td width = "10%"  align="center"><input type="radio" style="width:23px;height:23px"  name="sur_2" value= "3"></td>
				<td width = "10%"  align="center"><input type="radio" style="width:23px;height:23px"  name="sur_2" value= "4"></td>
			</tr>
			...
			<tr>
				...
				<td width = "10%"  align="center"><input type="radio" style="width:23px;height:23px"  name="sur_3" value= "2"></td>
				<td width = "10%"  align="center"><input type="radio" style="width:23px;height:23px"  name="sur_3" value= "3"></td>
				<td width = "10%"  align="center"><input type="radio" style="width:23px;height:23px"  name="sur_3" value= "4"></td>
			</tr>
			...
			<tr>
				...
				<td width = "10%"  align="center"><input type="radio" style="width:23px;height:23px"  name="sur_4" value= "2"></td>
				<td width = "10%"  align="center"><input type="radio" style="width:23px;height:23px"  name="sur_4" value= "3"></td>
				<td width = "10%"  align="center"><input type="radio" style="width:23px;height:23px"  name="sur_4" value= "4"></td>
			</tr>
			...
			<tr>
				...
				<td width = "10%"  align="center"><input type="radio" style="width:23px;height:23px"  name="sur_5" value= "2"></td>
				<td width = "10%"  align="center"><input type="radio" style="width:23px;height:23px"  name="sur_5" value= "3"></td>
				<td width = "10%"  align="center"><input type="radio" style="width:23px;height:23px"  name="sur_5" value= "4"></td>
			</tr>
			...
			<tr>
				...
				<td width = "10%"  align="center"><input type="radio" style="width:23px;height:23px"  name="sur_6" value= "2"></td>
				<td width = "10%"  align="center"><input type="radio" style="width:23px;height:23px"  name="sur_6" value= "3"></td>
				<td width = "10%"  align="center"><input type="radio" style="width:23px;height:23px"  name="sur_6" value= "4"></td>
			</tr>
			...
			<tr>
				...
				<td width = "10%"  align="center"><input type="radio" style="width:23px;height:23px"  name="sur_7" value= "2"></td>
				<td width = "10%"  align="center"><input type="radio" style="width:23px;height:23px"  name="sur_7" value= "3"></td>
				<td width = "10%"  align="center"><input type="radio" style="width:23px;height:23px"  name="sur_7" value= "4"></td>
			</tr>
			...
			<tr>
				...
				<td width = "10%"  align="center"><input type="radio" style="width:23px;height:23px"  name="sur_8" value= "2"></td>
				<td width = "10%"  align="center"><input type="radio" style="width:23px;height:23px"  name="sur_8" value= "3"></td>
				<td width = "10%"  align="center"><input type="radio" style="width:23px;height:23px"  name="sur_8" value= "4"></td>
			</tr>
			...
			<tr>
				...
				<td width = "10%"  align="center"><input type="radio" style="width:23px;height:23px"  name="sur_9" value= "2"></td>
				<td width = "10%"  align="center"><input type="radio" style="width:23px;height:23px"  name="sur_9" value= "3"></td>
				<td width = "10%"  align="center"><input type="radio" style="width:23px;height:23px"  name="sur_9" value= "4"></td>
			</tr>
