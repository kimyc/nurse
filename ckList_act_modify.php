					...
					<td align = "left">
						<?
							for($ss = 0; $ss<$DoingSCount; $ss++)
							{
								...
								//DB에 입력된 값 불러오기		
								$ck_sql = "
										SELECT sur_1 FROM nurse2016_ck_act where n_key = '$n_key' and p_key = '$p_key' and pbList_num = '$pbList_Num' and DoingL = '$DoingL_Num' and DoingS = '$DoingS_row[$ss]';
									   ";
								$ck_result = @mysql_query($ck_sql);
								$ck_db = mysql_result($ck_result, 0);
						...
						<b>	&nbsp;
							<label>
								<input type="radio" style="width:23px;height:23px;vertical-align: middle;" name="sur_1_<?=$i?>_<?=$ss?>" value= "1" <?if($ck_db==1) echo "checked"?>>
								1개월
							</label>

							&nbsp;
							<label>
								<input type="radio" style="width:23px;height:23px;vertical-align: middle;" name="sur_1_<?=$i?>_<?=$ss?>" value= "2" <?if($ck_db==2) echo "checked"?>>
								2개월
							</label>

							&nbsp;
							<label>
								<input type="radio" style="width:23px;height:23px;vertical-align: middle;" name="sur_1_<?=$i?>_<?=$ss?>" value= "3" <?if($ck_db==3) echo "checked"?>>
								3개월
							</label>

							<br>&nbsp;
							<label>
								<input type="radio" style="width:23px;height:23px;vertical-align: middle;" name="sur_1_<?=$i?>_<?=$ss?>" value= "4" <?if($ck_db==4) echo "checked"?>>
								4개월
							</label>

							&nbsp;
							<label>
								<input type="radio" style="width:23px;height:23px;vertical-align: middle;" name="sur_1_<?=$i?>_<?=$ss?>" value= "5" <?if($ck_db==5) echo "checked"?>>
								5개월
							</label>

							&nbsp;
							<label>
								<input type="radio" style="width:23px;height:23px;vertical-align: middle;" name="sur_1_<?=$i?>_<?=$ss?>" value= "6" <?if($ck_db==6) echo "checked"?>>
								6개월
							</label>
						</b>
						</font>
					...
					<td>
						...
						<?
							for($ss = 0; $ss<$DoingSCount; $ss++)
							{
								...
								//DB에 입력된 값 불러오기		
								$ck2_sql = "
										SELECT sur_2 FROM nurse2016_ck_act where n_key = '$n_key' and p_key = '$p_key' and pbList_num = '$pbList_Num' and DoingL = '$DoingL_Num' and DoingS = '$DoingS_row[$ss]';
									   ";
								$ck2_result = @mysql_query($ck2_sql);
								$ck2_db = mysql_result($ck2_result, 0);
						...
						<b>	&nbsp;
							<label>
								<input type="radio" style="width:23px;height:23px;vertical-align: middle;" name="sur_2_<?=$i?>_<?=$ss?>" value= "1" <?if($ck2_db==1) echo "checked"?>>
								수시로
							</label>

							&nbsp;&nbsp;
							<label>
								<input type="radio" style="width:23px;height:23px;vertical-align: middle;" name="sur_2_<?=$i?>_<?=$ss?>" value= "2" <?if($ck2_db==2) echo "checked"?>>
								매일
							</label>

							&nbsp;
							<label>
								<input type="radio" style="width:23px;height:23px;vertical-align: middle;" name="sur_2_<?=$i?>_<?=$ss?>" value= "3" <?if($ck2_db==3) echo "checked"?>>
								주5-6회
							</label>

							<br>&nbsp;
							<label>
								<input type="radio" style="width:23px;height:23px;vertical-align: middle;" name="sur_2_<?=$i?>_<?=$ss?>" value= "4" <?if($ck2_db==4) echo "checked"?>>
								주3-4회
							</label>

							&nbsp;
							<label>
								<input type="radio" style="width:23px;height:23px;vertical-align: middle;" name="sur_2_<?=$i?>_<?=$ss?>" value= "5" <?if($ck2_db==5) echo "checked"?>>
								주1-2회
							</label>

							&nbsp;
							<label>
								<input type="radio" style="width:23px;height:23px;vertical-align: middle;" name="sur_2_<?=$i?>_<?=$ss?>" value= "6" <?if($ck2_db==6) echo "checked"?>>
								필요시
							</label>
						</b>
						</font>
					...
					<td>
						<?
							for($ss = 0; $ss<$DoingSCount; $ss++)
							{
								//DB에 입력된 값 불러오기		
								$ck3_sql = "
										SELECT sur_3 FROM nurse2016_ck_act where n_key = '$n_key' and p_key = '$p_key' and pbList_num = '$pbList_Num' and DoingL = '$DoingL_Num' and DoingS = '$DoingS_row[$ss]';
									   ";
								$ck3_result = @mysql_query($ck3_sql);
								$ck3_db = mysql_result($ck3_result, 0);
						...
						<b>	&nbsp;
							<label>
								<input type="radio" style="width:23px;height:23px;vertical-align: middle;" name="sur_3_<?=$i?>_<?=$ss?>" value= "1" <?if($ck3_db==1) echo "checked"?>>
								10분
							</label>

							&nbsp;
							<label>
								<input type="radio" style="width:23px;height:23px;vertical-align: middle;" name="sur_3_<?=$i?>_<?=$ss?>" value= "2" <?if($ck3_db==2) echo "checked"?>>
								20분
							</label>

							&nbsp;
							<label>
								<input type="radio" style="width:23px;height:23px;vertical-align: middle;" name="sur_3_<?=$i?>_<?=$ss?>" value= "3" <?if($ck3_db==3) echo "checked"?>>
								30분
							</label>

							<br>&nbsp;
							<label>
								<input type="radio" style="width:23px;height:23px;vertical-align: middle;" name="sur_3_<?=$i?>_<?=$ss?>" value= "4" <?if($ck3_db==4) echo "checked"?>>
								40분
							</label>

							&nbsp;
							<label>
								<input type="radio" style="width:23px;height:23px;vertical-align: middle;" name="sur_3_<?=$i?>_<?=$ss?>" value= "5" <?if($ck3_db==5) echo "checked"?>>
								50분
							</label>

							&nbsp;
							<label>
								<input type="radio" style="width:23px;height:23px;vertical-align: middle;" name="sur_3_<?=$i?>_<?=$ss?>" value= "6" <?if($ck3_db==6) echo "checked"?>>
								60분이상
							</label>
						</b>
						</font>
